...
import { ZkDuelGame } from './games/zk-duel/ZkDuelGame';

const GAME_ID = 'zk-duel';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Zk Duel';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ZK_DUEL_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
